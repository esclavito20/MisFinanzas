...
# todo lo necesario y rellena las rutas de los wheels antes de invocarlo.
#
...
# Wheels de PySide6 y shiboken6 compilados para Android (aarch64). Los rellena
# CONSTRUIR_APK.sh tras descargarlos con: qtpip download PySide6 --android
wheel_pyside =
